...
int main(){
  ...
  signal_operation_global.firstO_lowPass_filter(&voltage_input,&voltage_input,500);
  signal_operation_global.firstO_lowPass_filter(&current_input,&current_input,500);
